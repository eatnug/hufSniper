...
class Form extends React.Component {
  ...
  render() {
    return (
      <div className="form__self">
        <label className="form__label">
          년도:
          <select
            className="form__select"
            id="ag_ledg_year"
            value={this.state.ag_ledg_year}
        ...
        <label className="form__label">
          ...
          <select
            className="form__select"
            id="ag_ledg_sessn"
            value={this.state.ag_ledg_sessn}
            onChange={this.changeHandler}
          >
        ...
        <label className="form__label">
          ...
          <select
            className="form__select"
            id="ag_crs_strct_cd"
            value={this.state.ag_crs_strct_cd}
            onChange={this.changeHandler}
          >
            ...
            <option value="A1CG1_H1">
              (서울)-ELLT학과(Department of English Linguistics &amp; Language
              Technology)
            </option>
            ...
            <option value="A5A_H1">
              (서울)-KFL학부(Division of Korean as a Foreign Language)
            </option>

            <option value="AKAA1_H1">
              (서울)-Language &amp; Diplomacy전공(Language &amp; Diplomacy)
            </option>
            ...
            <option value="A2AA1_H1">
              (서울)-Language &amp; Trade전공(Language &amp; Trade)
            </option>

            <option value="A2A_H1">
              (서울)-Language &amp; Trade학부(Division of Language &amp; Trade)
            </option>
            ...
            <option value="ACDD1_H1">
              (서울)-광고·PR·브랜딩전공(Advertising·Public Relations·Branding)
            </option>
            ...
            <option value="AEAA1_H1">
              (서울)-국제통상학과(Department of International Economics and Law)
            </option>
            ...
            <option value="ANJA1_H1">
              (서울)-디지털인문한국학전공(Digital Korean Studies in Humanities)
            </option>

            <option value="ABC01_H1">
              (서울)-말레이.인도네시아어과(Department of Malay-Indonesian)
            </option>
            ...
            <option value="AAI01_H1">
              (서울)-스칸디나비아어과(Department of Scandinavian Languages)
            </option>
            ...
            <option value="AJD_H1">
              (서울)-융합일본지역학부(Division of Integrated Japanese Studies)
            </option>
            ...
            <option value="AJCA1_H1">
              (서울)-일본언어문화전공(Japanese Language, Literature and Culture)
            </option>

            <option value="AJC_H1">
              (서울)-일본언어문화학부(Division of Japanese Language, Literature
              and Culture)
            </option>

            <option value="ACBA1_H1">
              (서울)-정치외교학과(Department of Political Science and Diplomacy)
            </option>
            ...
            <option value="AICA1_H1">
              (서울)-중국언어문화전공(Chinese Language, Literature and Culture)
            </option>

            <option value="AIC_H1">
              (서울)-중국언어문화학부(Division of Chinese Language, Literature
              and Culture)
            </option>

            <option value="AIDA1_H1">
              (서울)-중국외교통상전공(Chinese Foreign Affairs and Commerce)
            </option>

            <option value="AID_H1">
              (서울)-중국외교통상학부(Division of Chinese Foreign Affairs and
              Commerce)
            </option>
        ...
        <label className="form__label">
          교양 영역:
          <select className="form__select" id="ag_compt_fld_cd" value={this.state.ag_compt_fld_cd} onChange={this.changeHandler}>
